...
func (c *shippingClient) ShipOrder(ctx context.Context, in *ShipOrderReq, opts ...grpc.CallOption) (*ShipOrderReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.shipping.job.v1.Shipping/ShipOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Shipping_ShipOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.shipping.job.v1.Shipping/ShipOrder",
	}
...
var Shipping_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.shipping.job.v1.Shipping",
	...
	Metadata: "shipping/job/v1/shipping.proto",
}
